...
*   **Columns**: The parameters of the event become the columns of the view.
*   **Tables**: The underlying tables that store the data have random character suffixes (e.g., `poolcreated_X3rbm4nC`) and should not be queried directly.
