...
Everything you need like the execution context and the decoded outputs is provided by the generated interface. Because the abstract contract's method is `external`, remember to mark this implementation with `override`.
