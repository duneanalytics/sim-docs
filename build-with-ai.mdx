...
3. For the URL, use our `llms-full.txt` file mentioned above.
4. Once configured, reference sim APIs documentation by typing `@simAPIs` (or your chosen name) in your Cursor chat window.
