...
## Full Documentation as Plain Text

For the complete documentation in a single LLM-friendly file, use [`https://docs.sim.dune.com/llms-full.txt`](https://docs.sim.dune.com/llms-full.txt).
