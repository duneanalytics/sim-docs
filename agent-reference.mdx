...
This reference is designed for **AI coding agents** like Claude Code, OpenAI Codex, Cursor Agent, Gemini CLI, Windsurf, GitHub Copilot, and similar. It's optimized for machine consumption: tables over prose, terse descriptions, and complete coverage of the API surface.
