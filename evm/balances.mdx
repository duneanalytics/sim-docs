...
openapi: "/openapi.json GET /v1/evm/balances/{address}"
...
Want to be notified when a wallet's balance changes instead of polling? Use the [Subscriptions API](/evm/subscriptions) to receive real-time webhook notifications for balance changes, activity, and transactions.
