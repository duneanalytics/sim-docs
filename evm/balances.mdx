...
```bash cURL
curl -X GET "https://api.sim.dune.com/v1/evm/balances/0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045?chain_ids=mainnet" \
  -H "X-Sim-Api-Key: YOUR_API_KEY"
```

```javascript JavaScript
const res = await fetch("https://api.sim.dune.com/v1/evm/balances/0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045?chain_ids=mainnet", {
