...
<Tip>
  Looking for only stablecoin balances? Use the dedicated <a href="/evm/stablecoins">Stablecoin Balances</a> endpoint or add `asset_class=stablecoin` to your request.
</Tip>
