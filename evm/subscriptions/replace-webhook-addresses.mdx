...
If you only need to add or remove specific addresses without replacing the entire list, use the [Update Webhook Addresses](/evm/subscriptions/update-webhook-addresses) endpoint instead.
</Warning>
