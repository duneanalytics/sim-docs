...
openapi: "/openapi.json GET /v1/evm/activity/{address}"
---
...
Want to receive activity as it happens instead of polling? Use the [Subscriptions API](/evm/subscriptions) to get real-time webhook notifications when new activity is detected for an address.
