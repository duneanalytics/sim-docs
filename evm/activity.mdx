...
Both filters are optional and can be combined. For example, to get only USDC receives:

```
GET /v1/evm/activity/{address}?token_address=0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48&activity_type=receive
```
