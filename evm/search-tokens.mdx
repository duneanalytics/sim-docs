...
description: "Search ERC20 and ERC721 tokens across supported EVM chains by symbol or name, with optional chain filters. ERC20 results are enriched with logo and decimals."
