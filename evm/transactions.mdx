...
openapi: "/openapi.json GET /v1/evm/transactions/{address}"
...
Want to be notified when a wallet sends or receives a transaction? Use the [Subscriptions API](/evm/subscriptions) to receive real-time webhook notifications instead of polling.