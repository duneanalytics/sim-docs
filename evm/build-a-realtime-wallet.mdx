...
<Note>
  The `exclude_spam_tokens` parameter provides a good baseline to filter out low-value and potentially malicious tokens, but you may want to implement custom filtering for your use case - learn more in our [Spam Filtering guide](/spam-filtering).
</Note>
