...
sim can be used either on the backend or directly from the frontend. If integrating sim from the frontend, you might want to consider using a Proxy to protect your API key.
